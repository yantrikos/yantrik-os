...
pub fn get_templates(instinct: &str) -> &'static [ProactiveTemplate] {
    match instinct {
        ...
        "emailwatch" => EMAIL_WATCH_TEMPLATES,
        _ => &[],
    }
}
...
static EMAIL_WATCH_TEMPLATES: &[ProactiveTemplate] = &[
    ProactiveTemplate {
        instinct: "emailwatch",
        min_bond: BondLevel::Stranger,
        text: "{message}",
    ...
    ProactiveTemplate {
        instinct: "emailwatch",
        min_bond: BondLevel::Acquaintance,
        text: "Heads up \u{2014} {message}",
        bond_suffixes: &[
            (BondLevel::Friend, "Want me to draft a reply?"),
            (BondLevel::PartnerInCrime, "I can handle this if you want."),
        ],
    },
];
