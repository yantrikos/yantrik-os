...
// ─── Default Mappings ───────────────────────────────────────────────────────
// Canonical implementations live in yantrik-companion-core::urge_defaults.
// Re-exported here for backward compatibility.

pub use yantrik_companion_core::urge_defaults::{default_category, default_time_sensitivity};
